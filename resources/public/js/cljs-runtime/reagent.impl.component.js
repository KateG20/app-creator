...
if((i < len)){
var k = (ks[i]);
var G__36067 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36068 = (i + (1));
m = G__36067;
i = G__36068;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35976 = c;
var G__35976__$1 = (((G__35976 == null))?null:G__35976.prototype);
if((G__35976__$1 == null)){
return null;
} else {
return (G__35976__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35977 = c;
var G__35977__$1 = (((G__35977 == null))?null:G__35977.prototype);
if((G__35977__$1 == null)){
return null;
} else {
return (G__35977__$1["render"]);
}
})() == null)))));
});
...
var G__35982 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35982) : reagent.impl.component.as_element.call(null,G__35982));
};
...
var _STAR_current_component_STAR__orig_val__35983 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35984 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35984);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35983);
}});
...
var c = this;
var G__36050_36075 = (c["cljsRatom"]);
if((G__36050_36075 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36050_36075);
}
...
var renders_36076 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36077 = cljs.core.first(cljs.core.vals(renders_36076));
if((cljs.core.count(renders_36076) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36076))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36077)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36077], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var render_fun__$1 = (function (){var or__5045__auto__ = render_fun;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var name = cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5045__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var name__$1 = (function (){var G__36051 = name;
switch (G__36051) {
case "":
...
var name = (function (){var G__36053 = fiber;
var G__36053__$1 = (((G__36053 == null))?null:(G__36053["type"]));
if((G__36053__$1 == null)){
return null;
} else {
return (G__36053__$1["displayName"]);
}
})();
var parent = (function (){var G__36054 = fiber;
if((G__36054 == null)){
return null;
} else {
return (G__36054["return"]);
}
})();
var path = (function (){var G__36055 = parent;
var G__36055__$1 = (((G__36055 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36055) : reagent.impl.component.fiber_component_path.call(null,G__36055)));
if((G__36055__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36055__$1)," > "].join('');
}
})();
...
var temp__5802__auto__ = (function (){var or__5045__auto__ = (function (){var G__36056 = c;
if((G__36056 == null)){
return null;
} else {
return (G__36056["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
return G__36057._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__5045__auto__ = (function (){var G__36058 = c;
if((G__36058 == null)){
return null;
} else {
return (G__36058["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var or__5045__auto____$1 = (function (){var G__36059 = c;
if((G__36059 == null)){
return null;
} else {
return G__36059._reactInternalInstance;
}
})();
...
var elem = (function (){var or__5045__auto__ = (function (){var G__36060 = instance;
if((G__36060 == null)){
return null;
} else {
return (G__36060["_currentElement"]);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var G__36061 = instance;
if((G__36061 == null)){
return null;
} else {
return G__36061._currentElement;
}
}
})();
var name = (function (){var G__36062 = elem;
var G__36062__$1 = (((G__36062 == null))?null:(G__36062["type"]));
if((G__36062__$1 == null)){
return null;
} else {
return (G__36062__$1["displayName"]);
}
})();
var owner = (function (){var or__5045__auto__ = (function (){var G__36063 = elem;
if((G__36063 == null)){
return null;
} else {
return (G__36063["_owner"]);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
return G__36064._owner;
}
}
})();
var path = (function (){var G__36065 = owner;
var G__36065__$1 = (((G__36065 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36065) : reagent.impl.component.component_path.call(null,G__36065)));
if((G__36065__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36065__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36066 = c;
var G__36066__$1 = (((G__36066 == null))?null:G__36066.constructor);
if((G__36066__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36066__$1);
}
}
})();
