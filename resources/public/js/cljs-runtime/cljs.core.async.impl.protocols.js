...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_25838 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_25838(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_25839 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_25839(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_25840 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_25840(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_25841 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_25841(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_25842 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_25842(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_25844 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_25844(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_25846 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_25846(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_25847 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_25847(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_25848 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_25848(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_25850 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_25850(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_25851 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_25851(b);
}
});
