...
var vec__35248 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
var seq__35249 = cljs.core.seq(vec__35248);
var first__35250 = cljs.core.first(seq__35249);
var seq__35249__$1 = cljs.core.next(seq__35249);
var start = first__35250;
var parts = seq__35249__$1;
...
(reagent.impl.util.PartialFn.prototype.call = (function (unused__10638__auto__){
var self__ = this;
var self__ = this;
var G__35264 = (arguments.length - (1));
switch (G__35264) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args35263){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args35263)));
}));
...
var _STAR_always_update_STAR__orig_val__35307 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__35308 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__35308);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__35307);
}} else {
