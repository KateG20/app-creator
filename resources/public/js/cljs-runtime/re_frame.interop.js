...
return [(function (){var pred__36255 = cljs.core.instance_QMARK_;
var expr__36256 = reactive_val;
if(cljs.core.truth_((pred__36255.cljs$core$IFn$_invoke$arity$2 ? pred__36255.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__36256) : pred__36255.call(null,reagent.ratom.RAtom,expr__36256)))){
return "ra";
} else {
if(cljs.core.truth_((pred__36255.cljs$core$IFn$_invoke$arity$2 ? pred__36255.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__36256) : pred__36255.call(null,reagent.ratom.RCursor,expr__36256)))){
return "rc";
} else {
if(cljs.core.truth_((pred__36255.cljs$core$IFn$_invoke$arity$2 ? pred__36255.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__36256) : pred__36255.call(null,reagent.ratom.Reaction,expr__36256)))){
return "rx";
} else {
if(cljs.core.truth_((pred__36255.cljs$core$IFn$_invoke$arity$2 ? pred__36255.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__36256) : pred__36255.call(null,reagent.ratom.Track,expr__36256)))){
return "tr";
} else {
return "other";
}
