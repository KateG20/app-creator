...
var G__36079 = o;
(G__36079[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36080 = o;
(G__36080[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__36122__i < G__36122__a.length) {G__36122__a[G__36122__i] = arguments[G__36122__i + 0]; ++G__36122__i;}
  args = new cljs.core.IndexedSeq(G__36122__a,0,null);
} 
...
var G__36082 = props;
var G__36082__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36082,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36082);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36082__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36083){
var map__36084 = p__36083;
var map__36084__$1 = cljs.core.__destructure_map(map__36084);
var props = map__36084__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36084__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36085){
var map__36086 = p__36085;
var map__36086__$1 = cljs.core.__destructure_map(map__36086);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36086__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__36088 = jsprops;
(G__36088["defaultValue"] = value);

(G__36088["onChange"] = (function (p1__36087_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36087_SHARP_);
}));
...
var vec__36090 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36090,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36090,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36090,(2),null);
...
var jsprops = ({"argv": v});
var temp__5808__auto___36128 = reagent.impl.template.key_from_vec(v);
if((temp__5808__auto___36128 == null)){
} else {
var key_36129 = temp__5808__auto___36128;
(jsprops["key"] = key_36129);
}
...
var temp__5808__auto___36130 = reagent.impl.template.key_from_vec(argv);
if((temp__5808__auto___36130 == null)){
} else {
var key_36131 = temp__5808__auto___36130;
reagent.impl.template.oset(jsprops,"key",key_36131);
}
...
var G__36094 = reagent.impl.template.__GT_NativeWrapper();
(G__36094["name"] = c);
...
var G__36095 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36095) : reagent.impl.template.as_element.call(null,G__36095));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36100){
...
var n__5636__auto___36144 = a.length;
var i_36145 = (0);
while(true){
if((i_36145 < n__5636__auto___36144)){
(a[i_36145] = reagent.impl.template.as_element((a[i_36145])));

var G__36146 = (i_36145 + (1));
i_36145 = G__36146;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5636__auto___36147 = a.length;
var i_36148 = (0);
while(true){
if((i_36148 < n__5636__auto___36147)){
var val_36149 = (a[i_36148]);
if(((cljs.core.vector_QMARK_(val_36149)) && ((reagent.impl.template.key_from_vec(val_36149) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36148] = reagent.impl.template.as_element(val_36149));

var G__36150 = (i_36148 + (1));
i_36148 = G__36150;
continue;
} else {
}
...
var ctx = ({});
var vec__36108 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36108,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36108,(1),null);
...
var G__36111 = (cljs.core.count(argv) - first_child);
switch (G__36111) {
case (0):
