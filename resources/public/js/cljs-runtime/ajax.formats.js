...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__37618){
var map__37619 = p__37618;
var map__37619__$1 = cljs.core.__destructure_map(map__37619);
var request = map__37619__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37619__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__37622 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37622.cljs$core$IFn$_invoke$arity$1 ? fexpr__37622.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37622.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__37624 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37624.cljs$core$IFn$_invoke$arity$1 ? fexpr__37624.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37624.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__37625){
var map__37626 = p__37625;
var map__37626__$1 = cljs.core.__destructure_map(map__37626);
var request = map__37626__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37626__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
